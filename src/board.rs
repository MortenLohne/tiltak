...
#[allow(clippy::unreadable_literal)]
pub const VALUE_PARAMS_6S: [f32; NUM_VALUE_PARAMS_6S] = [0.0; NUM_VALUE_PARAMS_6S];

#[allow(clippy::unreadable_literal)]
pub const POLICY_PARAMS_6S: [f32; NUM_POLICY_PARAMS_6S] = [0.0; NUM_POLICY_PARAMS_6S];
