...
fn black_win_in_one_move_test() {
    let move_strings = [
        ...
        "4c3<22", "c2", "c4", "1d4<", "1b4>", "d3", "b4", "b1", "d4", "1b2+", "2a3>", "e1",
        "5b3-23", "b3", "d1", "1e1<", "a5", "e1", "b5", "1b3+", "2c4<", "1e1+",
    ];
...
fn black_avoid_less_in_one_test5() {
    let move_strings = [
        ...
        "e1", "c4", "b4", "3d4<12", "d2", "1d1+", "4c2>", "3b4-", "1b2+", "1d4-", "3b3-12",
    ];
...
fn white_avoid_loss_in_one_test() {
    let move_strings = [
        ...
        "1d4-", "d4", "1c4-", "b2", "c4", "1d4-", "2c3>", "1d2+", "Sb3", "5d3-23", "1b3-", "d4",
        "2b2>11", "3c2+21", "b3", "b2", "1b3-", "c2", "b3", "c5", "2b2>", "b2", "1b3-", "b3",
...
fn white_avoid_loss_in_one_test2() {
    let move_strings = [
        ...
        "1c2+", "1c4-", "1d3<", "d5", "4c3>22", "1d5-", "2d3+", "Sc4", "3d4-", "1c4-", "c4",
        "2c3>", "1c4<", "5d3+", "2b4-11", "1b3-", "Se1", "4d4<13", "c3", "5b2>32", "1c3-", "3d2<",
        "b3", "3b4-", "b4", "1c4<", "d3", "c4", "1d3+", "1c4>", "e4", "2d4>", "2e3+", "2d4>", "d3",
        "a4",
    ];
...
fn do_not_suicide_as_black_test2() {
    let move_strings = [
        ...
        "5c3+23", "c2", "d3", "1d2+", "b4", "d2", "d4", "2d3+", "b3", "1b2+", "1b4-", "d3", "b2",
        "b1", "1b2>", "1d2<", "1c3-", "c1", "3b3>12", "1c1+", "1c3-", "3d4-", "4c2<22", "1b1+",
        "2a2>", "d2", "3b2<", "1d2<", "2b2>", "d4", "d2", "5d3-14",
    ];
...
fn do_not_suicide_as_black_test3() {
    let move_strings = [
        ...
        "b1", "a1", "d3", "c4", "2c3+", "1d4<", "Cc3", "3c4>12", "1c3+", "e1", "c3", "1a1>", "d1",
        "c5", "b5", "1b4+", "1d3+",
    ];
