...
fn pure_spread_into_road() {
    ...
    test_position.top_policy_move_prop::<6>(&["4f4<112", "4f4<13", "4f4<22", "3f4<12"]);
}
...
fn two_pure_spreads_into_road() {
    ...
    test_position.top_policy_move_prop::<6>(&["6d5-51", "6d5>51"]);
}
...
fn imperfect_cap_spread_onto_critical_square() {
    ...
    test_position.top_policy_move_prop::<5>(&["3c1<12", "3c1<21", "2c1<11"]);
}
...
fn simple_flat_movement_onto_critical_square() {
    ...
    test_position.top_policy_move_prop::<5>(&["b2>", "c1+"]);
}
...
fn pure_spread_onto_critical_square() {
    ...
    test_position.top_policy_move_prop::<6>(&["e4>"]);
}
...
fn pure_spread_without_critical_square() {
    ...
    test_position.top_policy_move_prop::<6>(&["4b3>1111"]);
}
...
fn winning_wall_spread_from_critical_square() {
    ...
    test_position.top_policy_move_prop::<6>(&["2d6<", "2d6>", "2d6<11"]);
}
