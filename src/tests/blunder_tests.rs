...
fn do_not_blunder_road_win() {
    ...
    test_position.plays_correct_move_short_prop::<6>(&[
...
fn do_not_blunder_road_win2() {
    ...
    test_position.plays_correct_move_short_prop::<6>(&["2e4-", "e1+", "Sd4", "Sc4", "e1>", "2d3>"])
}
...
fn do_not_blunder_road_win3() {
    ...
    test_position
        .plays_correct_move_short_prop::<6>(&["b6>", "5c5+", "3c5+", "Sb5", "b6<", "6c5+", "3c5<"])
}
...
fn do_not_blunder_road_win6() {
    ...
    test_position.plays_correct_move_short_prop::<6>(&["Se5", "Se6", "c5+", "e4>"])
}
